...
console.log("INEQUILITY TEST WITH STRINGS: ", ("Train" as string) != "car");
...
console.log("INEQUALITY TEST WITH NUMBERS ", (54 as number) != 59);
...
//using "or"
console.log("OR OPERATOR TEST:  " , (6 as number) === 4 || 12 >6 );

//whether an iteam is in a array
const cities :string[] = ['karachi', 'lahore', 'maree','swat'];
console.log('PRINT  "SWAT" IN ARRAY: ', cities.includes("swat"));

// item not  in array
const places :string[]=['school','park','mall','market'];
